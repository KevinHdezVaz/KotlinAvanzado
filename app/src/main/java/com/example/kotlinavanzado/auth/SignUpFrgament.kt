...
import com.example.kotlinavanzado.databinding.FragmentSignUpFrgamentBinding

class SignUpFrgament : Fragment() {

    private lateinit var binding: FragmentSignUpFrgamentBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSignUpFrgamentBinding.inflate(inflater)
        setupSignUpButton()
        return binding.root
